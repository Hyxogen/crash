...
pid_t			cm_if_clause(t_minishell *sh, t_snode *ifnode, const int io[3], int closefd);
pid_t			cm_for_clause(t_minishell *sh, t_snode *ifnode, const int io[3], int closefd);
pid_t			cm_case_clause(t_minishell *sh, t_snode *ifnode, const int io[3], int closefd);
...
int				cm_expand_list(t_minishell *sh, t_expand *exp, t_token *token);
...
pid_t			cm_unimplemented_cmd_command(t_minishell *sh, t_snode *node, const int io[3], int closefd);
